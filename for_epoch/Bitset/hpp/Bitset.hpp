...
public:
    ...
    Bitset& operator = (const Bitset<SIZE> &val)
    {
#ifdef DEBUG
    ...
    Bitset& operator = (Bitset<SIZE> &&val)
    {
#ifdef DEBUG
...
private:
    ...
    // Storage
    BlockType  *_pBits;  // to hold a large-enough bit set I need to allocate mem on heap
    SizeType    _bitNum;
    SizeType    _blockNum;
};
