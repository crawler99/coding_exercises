...
TEST(FindStrInMatrix, Correctness)
{
    ...
    {
        "AKDEOPTIVEREVITPOVEREVITPOPTIVER",
        "RKDEPPTIVERDXPOTIVERXXXXXXXXXXXX",
        "EKDETPTIVERDXTPTIVERXXXXXXXXXXXX",
        "VKDEIPTREVITPOTTIVERXXXXXXXXXXXX",
        "IKDEVPTIVEREVITPOVERXXXXXXXXXXXX",
        "TKDEEPTIVERDXOVTIVERXXXXXXXXXXXX",
        "PKDERPTIVERDXOETIVERXXXXXXXXXXXX",
        "OKDEOPTIVERDXORTIVERXXXXXXXXXXXX",
    };
    EXPECT_EQ(9, finder.find(input));
}
